 ...
 *** ocamlopt.opt
 ...
 program = "${test_build_directory}/exception_handler.opt"
 all_modules = "fp_backtrace.c exception_handler.ml"
 reference = "${test_source_directory}/exception_handler.reference"
 **** run
 output = "exception_handler.output"
